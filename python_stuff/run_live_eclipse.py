...
# File to be called from Quack Eclipse in order to run classification system.
'''
TODO:
1) remove SVM prompting, does this even make sense then?, TSVM?
3) Add command line parameters to take in query string, corpus, 
4) figure out how to call from java
'''
